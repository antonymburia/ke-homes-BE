...
Revision ID: fcd1bd941244
Revises: 
Create Date: 2022-03-18 07:00:56.679111
...
def upgrade():
    ...
    op.create_index(op.f('ix_landlords_landlord_name'), 'landlords', ['landlord_name'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_landlords_landlord_name'), table_name='landlords')
